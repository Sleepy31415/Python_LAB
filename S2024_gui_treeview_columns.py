...
tree_2_scrollbar = tk.Scrollbar(main_window)  # define the scrollbar
tree_2_scrollbar.grid(row=6, columnspan=50, padx=padx, pady=pady, sticky='ns')  # place the scrollbar
tree_1 = ttk.Treeview(main_window, yscrollcommand=tree_1_scrollbar.set,xscrollcommand=tree_2_scrollbar.set, selectmode="browse")  # define the treeview, connect it with the scrollbar
...
tree_2_scrollbar.config(command=tree_1.xview)
