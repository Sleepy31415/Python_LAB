...
#treeview grid
tree_1.grid(row=0, column=0, padx=padx*2)
...
tree_1.column("Id", anchor=tk.E, width=90)  # "E" stands for East, meaning Right. Possible anchors are N, NE, E, SE, S, SW, W, NW and CENTER
...
# button grids
create_button.grid(row=2, column=0, padx=(padx, padx), pady=(pady*2,pady))
update_button.grid(row=2, column=1, padx=(padx, padx), pady=(pady*2,pady))
delete_button.grid(row=2, column=2, padx=(padx, padx), pady=(pady*2,pady))
clear_button.grid(row=2, column=3, padx=(padx, padx), pady=(pady*2,pady))
